...
const MeetingPoint = () => (
  <div className="antialiased text-gray-600">
    ...
    <Section
      ...
      description="La entrega de nuestros productos es en la Estación Floresta del Ferrocarril Sarmiento. Calles: Bahía Blanca y Yerbal, Buenos Aires, CABA. El horario de entrega se coordina a través de nuestro WhatsApp."
    >
      <Iframe
